...
//go:generate go run ../tools/codegen normalize-schemas internal/nfe/schemas/v1_0/dist_dfe internal/nfe/schemas/v1_0/ator_interessado internal/nfe/schemas/v1_0/evento_generico internal/nfe/schemas/v1_0/evento_mde internal/nfe/schemas/v1_0/evento_insucesso internal/nfe/schemas/v1_0/evento_cancel_insucesso internal/nfe/schemas/v2_0/cons
//go:generate xgen -i ../schemas/v1_0/ator_interessado -o ./v1_0/ator_interessado -l Go
...
//go:generate xgen -i ../schemas/v1_0/evento_generico -o ./v1_0/evento_generico -l Go
//go:generate xgen -i ../schemas/v1_0/evento_mde -o ./v1_0/evento_mde -l Go
//go:generate xgen -i ../schemas/v1_0/evento_insucesso -o ./v1_0/evento_insucesso -l Go
//go:generate xgen -i ../schemas/v1_0/evento_cancel_insucesso -o ./v1_0/evento_cancel_insucesso -l Go
//go:generate xgen -i ../schemas/v1_0/epec -o ./v1_0/epec -l Go
//go:generate xgen -i ../schemas/v1_0/dist_dfe -o ./v1_0/dist_dfe -l Go
//go:generate xgen -i ../schemas/v2_0/cons -o ./v2_0/cons -l Go
